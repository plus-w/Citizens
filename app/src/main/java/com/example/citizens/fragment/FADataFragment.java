 ...
 * Use the {@link FADataFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FADataFragment extends Fragment {
    ...
    private SmartTable<FATeamStatistics> mTeamTable;
    private TableData<FATeamStatistics> mTeamTableData;

    private SmartTable<FAPlayerStatistics> mPlayerTable;
    private TableData<FAPlayerStatistics> mPlayerTableData;
...
//     * @param param2 Parameter 2.
     * @return A new instance of fragment FADataFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FADataFragment newInstance() {
        FADataFragment fragment = new FADataFragment();
...
//            mParam2 = getArguments().getString(ARG_PARAM2);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_fa_data, container, false);
        mTeamTable = v.findViewById(R.id.table_fa_team);
        mPlayerTable = v.findViewById(R.id.table_fa_player);
...
//        Column<String> npXGXANpPer90Col = new Column<String>("场均非点球期望进球+助攻", "npXGXANpPer90");
        ...
        List<FAPlayerStatistics> statList = new ArrayList<>();

        for (int i = 0; i < jsonArray.length(); i++) {
            JSONObject obj = (JSONObject) jsonArray.get(i);
            statList.add(new FAPlayerStatistics(obj));
        }
...
//        Column<String> npXGXANpPer90Col = new Column<String>("场均非点球期望进球+助攻", "npXGXANpPer90");
        ...
        List<FATeamStatistics> statList = new ArrayList<>();
//        Toast.makeText(getContext(), jsonArray.toString(), Toast.LENGTH_SHORT).show();
        for (int i = 0; i < jsonArray.length(); i++) {
            JSONObject obj = (JSONObject) jsonArray.get(i);
            statList.add(new FATeamStatistics(obj));
        }
