...
import com.example.citizens.model.UCLPlayerStatistics;
import com.example.citizens.model.UCLTeamStatistics;
 ...
 * Use the {@link UCLDataFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class UCLDataFragment extends Fragment {
    ...
    private SmartTable<UCLTeamStatistics> mTeamTable;
    private TableData<UCLTeamStatistics> mTeamTableData;

    private SmartTable<UCLPlayerStatistics> mPlayerTable;
    private TableData<UCLPlayerStatistics> mPlayerTableData;
...
//     * @param param2 Parameter 2.
     * @return A new instance of fragment UCLDataFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static UCLDataFragment newInstance() {
        UCLDataFragment fragment = new UCLDataFragment();
...
//            mParam2 = getArguments().getString(ARG_PARAM2);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_ucl_data, container, false);
        mTeamTable = v.findViewById(R.id.table_ucl_team);
        mPlayerTable = v.findViewById(R.id.table_ucl_player);
...
//        Column<String> npXGXANpPer90Col = new Column<String>("场均非点球期望进球+助攻", "npXGXANpPer90");
        ...
        List<UCLPlayerStatistics> statList = new ArrayList<>();

        for (int i = 0; i < jsonArray.length(); i++) {
            JSONObject obj = (JSONObject) jsonArray.get(i);
            statList.add(new UCLPlayerStatistics(obj));
        }
...
//                mTableData.
    ...
    public void setTeamTableData(JSONArray jsonArray) throws JSONException {
        // create columns
...
//        Column<String> npXGXANpPer90Col = new Column<String>("场均非点球期望进球+助攻", "npXGXANpPer90");
        ...
        List<UCLTeamStatistics> statList = new ArrayList<>();
//        Toast.makeText(getContext(), jsonArray.toString(), Toast.LENGTH_SHORT).show();
        for (int i = 0; i < jsonArray.length(); i++) {
            JSONObject obj = (JSONObject) jsonArray.get(i);
            statList.add(new UCLTeamStatistics(obj));
        }
