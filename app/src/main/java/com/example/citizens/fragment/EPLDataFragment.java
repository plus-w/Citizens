 ...
 * Use the {@link EPLDataFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class EPLDataFragment extends Fragment {
    ...
    private SmartTable<EPLPlayerStatistics> mPlayerTable;
    private TableData<EPLPlayerStatistics> mPlayerTableData;
    ...
    private SmartTable<EPLTeamStatistics> mTeamTable;
    private TableData<EPLTeamStatistics> mTeamTableData;

    public EPLDataFragment() {
...
//     * @param param2 Parameter 2.
     * @return A new instance of fragment EPLDataFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static EPLDataFragment newInstance() {
        EPLDataFragment fragment = new EPLDataFragment();
...
//            mParam2 = getArguments().getString(ARG_PARAM2);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_epl_data, container, false);
        mTeamTable = v.findViewById(R.id.table_epl_team);
        mPlayerTable = v.findViewById(R.id.table_epl_player);
...
//        Column<String> npXGXANpPer90Col = new Column<String>("场均非点球期望进球+助攻", "npXGXANpPer90");
        ...
        List<EPLPlayerStatistics> statList = new ArrayList<>();

        for (int i = 0; i < jsonArray.length(); i++) {
            JSONObject obj = (JSONObject) jsonArray.get(i);
            statList.add(new EPLPlayerStatistics(obj));
        }
...
//        Column<String> npXGXANpPer90Col = new Column<String>("场均非点球期望进球+助攻", "npXGXANpPer90");
        ...
        List<EPLTeamStatistics> statList = new ArrayList<>();
//        Toast.makeText(getContext(), jsonArray.toString(), Toast.LENGTH_SHORT).show();
        for (int i = 0; i < jsonArray.length(); i++) {
            JSONObject obj = (JSONObject) jsonArray.get(i);
            statList.add(new EPLTeamStatistics(obj));
        }
